...
$omp_config = "C:\Users\ondra-pragmax\.config\oh-my-posh\ondra.atomicBit.omp.json"
...
[ScriptBlock]$Prompt = {
	...
	$global:TestRealLastExitCode = $realLASTEXITCODE
	Write-Host "TestLastCommandSuccess: $TestLastCommandSuccess"
	Write-Host "TestRealLastExitCode: $TestRealLastExitCode"
